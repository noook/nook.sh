...
<template>
  ...
  >
    <!-- border gradient -->
    <div class="absolute inset-x-0 bottom-0 top-0 rounded-t-lg bg-linear-to-b from-white/20 to-transparent" />

    <!-- top highlight -->
    <div class="absolute inset-x-0 top-0 h-px bg-linear-to-r from-transparent via-white/50 to-transparent" />
